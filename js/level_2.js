monogatari.script ({
	...
	'PathDist': [
		...
		'hide character dist Normal with fadeOut',
		'show character dist BF with fadeIn',
		'dist I am on vacation, and I just started a 12 hour sponsored stream.',
		'dist And I am testing a new frame-perfect glitch to save 5 seconds on runs!',
	...
	'DistChat': [
		...
		'dist What the fuck do you know about Speedrunning?', 
		'dist Stupid idiot.', 
		'hide character dist with fadeOut',
		'show character pepe Normal with fadeIn',
		'pepe "I tried this earlier, and got it first attempt"',
		'pepe "Cry less practice more"',
		'pepe "This is hard to watch..."',
		'hide character pepe with fadeOut',
		'show character dist Mad with fadeIn',
	...
	'PathEla': [
		...
		'ela By the way, I have 10k viewers. Meow.',
